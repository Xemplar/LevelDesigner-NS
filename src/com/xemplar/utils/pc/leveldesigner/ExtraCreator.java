...
public class ExtraCreator {
    ...
    public ExtraCreator(String name, int id, String image, String[] args){
        try{
    ...
    private ExtraCreator(String name, int id, BufferedImage img, String[] args){
        this.id = id;
        this.img = img;
        this.args = args;
        this.name = name;
    ...
    public ExtraCreator clone(){
        return new ExtraCreator(name, id, img, args);
    }
